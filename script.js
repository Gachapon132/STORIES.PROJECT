...
function loadVoices() {
    ...
    // try to pick an expressive English voice if present
    chosenVoice = availableVoices.find(v => /en|english/i.test(v.lang) && /female|google|wave/i.test(v.name.toLowerCase()))
        || availableVoices[0];
}
